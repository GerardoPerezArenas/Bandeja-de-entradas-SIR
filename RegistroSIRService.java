...
public class RegistroSIRService {
            ...
            if(elRegistroESVO!=null){
                ...
                if (codigoProcedimientoPlatea != null && !codigoProcedimientoPlatea.isEmpty() && !codigoProcedimientoPlatea.equalsIgnoreCase("null")) {
                    ...
                    try {
                        ...
                        sirDestinoRRes.setFechaRegistroSistemaSIR(
                                lan6AsientoRegistralRespuesta.getFechaRegistroInicial()
                        );
    ...
    public Lan6EstadoAsientoRegistral getEstadoAsientoEntradaSIRByID(String  idAsientoESSIR, String codigoProcedimiento)
    {
        Lan6EstadoAsientoRegistral respuesta = null;
       try {
           respuesta = new Lan6AE20IntercambioRegistralServicios(codigoProcedimiento).getEstadoAsientoRegistral(idAsientoESSIR);
        } catch (Exception e) {
           log.error("Error al recuperar Datos estado de una entrada en el SIR : " + e.getMessage(), e);
        }
       return respuesta;
    }
