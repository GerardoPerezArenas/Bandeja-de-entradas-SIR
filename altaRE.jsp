...
// Se comprueba si hay bloqueo de fecha y hora en caso de hacer una respuesta  para una anotaci�n de salida
...
function mostrarDestino() {
    ...
    <% if ("E".equals(tipoAnotacion) || "Relacion_E".equals(tipoAnotacion)) {%>
        if (document.forms[0].cbTipoEntrada.value=='') {
            ...
            // Cambiar 'tipo documento' y UOR a obligatorio si estamos en modificaci�n o alta.
            ...
            if (""==borrarCampos || (""!=borrarCampos && "0"!=borrarCampos)) {
                // Cambiar 'tipo documento' y UOR a NO obligatorio si estamos en modificaci�n o alta.
                // Adem�s, borrar tipo de documento y remitente.
                document.forms[0].txtCodigoDocumento.value = '';
...
function recuperaDatos(datos,datosTercero,listaTemas,lista_CODtiposDocumentos, lista_DESCtiposDocumentos, lista_ACTtiposDocumentos,
        ...
        listaExpedientesRelacionados, contIdNumsExpedientesRelacionados,registroTelematico,esRegTelemModificable, procedimientoDigitalizacion, finDigitalizacion,bloquearProcedimiento){                 
            ...
            if(datos[68]=="true"){ /**  Si el asunto de la anotaci�n est� dado de baja **/
            ...
            // #270948: Se abre el componente de digitalizaci�n si as� se indica
...
function pulsarModificar(idPestana) {
    ...
    if (rolPorDefecto==''){
        ...
        mod=0;
        activarFormulario();        
        //NO SE PUEDE MODIFICAR LA FECHA DE GRABACI�N
...
function confirmarModificacion() {
    ...
    desactivarInteresado();
        ...
        // TEMAS
        var l = new Array();
        for (i=0; i < lista.length; i++) l[i]=lista[i][0]+'��'; // Solo c�digos
            ...
            if (validarObligatoriosAqui() && validaRetramitarDocCambioProcedimiento()) {
                if ((comprobarFecha(document.forms[0].fechaAnotacion,mensajeFechaNoValida)) && (comprobarFecha(document.forms[0].fechaDocumento,mensajeFechaNoValida))) {
                    if (comparaFecha()) {
                        ...
                        // aunque esten vac�os o no se copian al form.
                        habilitarTipoDocYRemitente();
                        // Datos SIR
                        if($('[name="codigoUnidadDestinoSIRHidden"]') != undefined){
                            $('[name="codigoUnidadDestinoSIRHidden"]').val($('[name="codigoUnidadDestinoSIR"]').val());
...
<% }%>
    ...
    if (tipoEntrada === '1') {
        ...
        // Aquí rellenamos el campo con un texto por defecto
...
function cambiaFoco() {
    if (cambiaElFoco) {
      ...
      function valoresPorDefectoCombos() {
          ...
          function borrarPaginaBuscada() {
              ...
              document.forms[0].txtPart.value=''; // Part�culas.
              ...
              document.forms[0].txtDomicilio.value=''; // Nombre v�a.
    ...
    borrarProcedenteOtroReg();
	      ...
	      document.forms[0].modoAlta.value=1;
              ...
              document.forms[0].fechaAnotacion.value=fechaServidor;
            //fechad e grabaci�n la da el servidor no puede ser modificada
              document.forms[0].fechaDocumento.value=fechaServidor;
              var vectorFecDoc = [document.forms[0].fechaDocumento];
              deshabilitarGeneral(vectorFecDoc);
           ...
           // Se vac�a el c�digo del expediente y su descripci�n relacionado si tuviesen alg�n valor           
           document.getElementById("codListaExpedientesRelacionados").value="";
           document.getElementById("descListaExpedientesRelacionados").value="";
       }
...
function pulsarImprimirCuneus(grabarDuplicar){
    ...
    function abrirInforme(nombre,tipoFichero) {
        ...
        if (!(nombre =='')) {
            ...
            if (tipoFichero == 'html') {
                // Es imprescindible abrir en una ventana nueva sin frames para poder imprimir bien el cu�o en la Epson TM-295
        ...
        if (!comprobarSiJustificanteCSV(tituloDoc)) {
            ...
            if (tipo != '') {
                ...
                if (tipo === 'application/pdf') {
                    ...
                    } else if (top.menu.modificando === 'N') { // Si no se est� modificando el registro no se debe permitir el cotejo.
...
function validarNif(campo) {
   ...
   // var navigator=navigator.userAgent.toLowerCase().indexOf('chrome') > -1
    ...
    // Primero comprobamos si el NIF esta vacio, en ese caso no permitir� seguir completando el formulario
...
function pulsarCancelarAlta() {
    ...
    if (document.forms[0].opcionAltaDesdeConsulta.value=="SI"){ 
        ...
        // hay que recargar el combo de asunto ya que se cargar�n con todos los asuntos de registro existentes, incluidos
    ...
    function resfrescaTablaDocumentosDigitalizacion(){
     ...
     var numero=document.forms[0].numero.value;
         ...
         if(ajaxResult){
            ...
            } else jsp_alerta("A","Ha ocurrido un error al recuperar los datos que necesita el complemento de digitalizaci�n para ejecutarse.")
        });
...
<div class="encabezadoGris" id="tablaBuscar">
    ...
    <div id="divDatosRegistroSIR" style="float:left;position:relative;top:-2px;display:none;">
        ...
        <input type="text" class='inputTexto inputTextoDeshabilitado' readonly id="identificadorRegistroSIR" name="identificadorRegistroSIR"/>
    </div>
    <div style="float:left;width:60%;position:relative;top:-2px" id="divTablaBotones">
        <TABLE class="tablaBotones" width="100%" cellpadding="0px" cellspacing="0px" border="0">
            <TR>
                ...
                <TD style="height:20px;vertical-align:top"><!-- Cu�o -->
                    <DIV id="capaCunho" name="capaCunho" STYLE="position:relative;width:100%; visibility:hidden;height:0px;cursor:pointer">
                        <a class="botonjustificante" title='<%=descriptor.getDescripcion("altHistorico")%>' alt='<%=descriptor.getDescripcion("altHistorico")%>' href="" onClick="javascript:{pulsarHistoricoAnotacion();return false;}"><%=descriptor.getDescripcion("etiqHistorico")%></a>
                         ...
                         <% }%>
                        <span class="fa fa-registered botonjustificante" name="cmdCuneus" id="cmdCuneus" onClick="javascript:{pulsarImprimirCuneus('no');return false;}" alt="<%=descriptor.getDescripcion("altSello")%>" title="<%=descriptor.getDescripcion("altSello")%>">
                    </DIV>
                    ...
                    <TABLE id ="tablaDatosGral" class="contenidoPestanha">
                                        ...
                                        <TD style="width: 50%">
                                            ...
                                            <div style="width: 80%;float:left" class="columnP">
                                                ...
                                                <html:text styleId="obligatorio" styleClass="inputTextoObligatorio" property="cbTipoEntrada"  style="width:18%" maxlength="1" onkeyup="return SoloDigitosNumericos(this);"
                                                           ...
                                                           onchange="javascript:{divSegundoPlano=true; inicializarValores('cbTipoEntrada','txtNomeTipoEntrada',cod_tipoEntrada,desc_tipoEntrada); actualizarComboEstadoSegunTipoEntrada();}"
                        ...
                        <TR>
                            <TD colspan="2">
                                ...
                                <!-- ✅ Combo Alternativo si Tipo Entrada == 1 -->
                                <div id="capaTiposEstadoAnotacionAlt" name="capaTiposEstadoAnotacionAlt" style="width:50%;float:left;display:none;">
                                    <span class="etiqueta"><%=descriptor.getDescripcion("etiq_estadoAnot")%>:&nbsp;</span>
                                    <span class="columnP">
                                        <html:text styleId="noObligatorioAlt" styleClass="inputTexto"  property="cod_estadoAnotacionAlt"
                                                   style="width:10%" value="" maxlength="1"
                                                   onkeyup="return SoloDigitosNumericos(this);"
                                                   onfocus="javascript:this.select();"
                                                   onchange="javascript:{divSegundoPlano=true;inicializarValores('cod_estadoAnotacionAlt','desc_estadoAnotacionAlt',cod_estadosAnotacionesAlt,desc_estadosAnotacionesAlt);}"/>
                                        <html:text styleClass="inputTexto" styleId="noObligatorioAlt"  property="desc_estadoAnotacionAlt"
                                                   style="width:68%" readonly="true" value=""
                                                   onfocus="javascript:{divSegundoPlano=true;inicializarValores('cod_estadoAnotacionAlt','desc_estadoAnotacionAlt',cod_estadosAnotacionesAlt,desc_estadosAnotacionesAlt);}"
                                                   onclick="javascript:{divSegundoPlano=false;inicializarValores('cod_estadoAnotacionAlt','desc_estadoAnotacionAlt',cod_estadosAnotacionesAlt,desc_estadosAnotacionesAlt);}"/>
                                        <a href="javascript:{divSegundoPlano=false;inicializarValores('cod_estadoAnotacionAlt','desc_estadoAnotacionAlt',cod_estadosAnotacionesAlt,desc_estadosAnotacionesAlt);}"
                                           style="text-decoration:none;" id="anclaDAlt" name="anchorEstadoAnotacionAlt" onclick="javascript:window.focus();">
                                            <span class="fa fa-chevron-circle-down" aria-hidden="true" id="despAlt" name="botonEstadoAnotacionAlt"
                                                  alt="<%=descriptor.getDescripcion("altDesplegable")%>" 
                                                  title="<%=descriptor.getDescripcion("altDesplegable")%>" style="cursor:hand;"></span>
                                        </a>
                                    </span>
                                </div>
                            </TD>
                            ...
                            <TD colspan="2">
                                <div style="width: 50%;float:left">
                                    ...
                                    <span style="width: 90%" class="columnP">
                                        ...
                                        <%}%>
                                        <!-- #231150: se a�ade onBlur para que cargue siempre los documentos del procedimiento-->
...
<!-- Definimos varias capas para los botones seg�n lo que se permite hacer. -->
...
<% if (permisoMantenimiento) {%>
    ...
    -->
        <DIV id="capaBotones2" name="capaBotones2" style="display:none" class="botoneraPrincipal">
            ...
            <% } %>
            <!--FIN BOT�N DE CANCELAR -->
            
            <!-- #270948: Bot�n Digitalizar -->
            <% if (mostrarDigitalizar && !"reservas".equals(respOpcion)) { %>
...
<DIV id="capaBotones3" name="capaBotones3" style="display:none" class="botoneraPrincipal">
    ...
    <!-- Fin bot�n RELACIONAR -->
<% }%>
    <!-- Bot�n SALIR CONSULTAR. -->
    ...
    <!-- Fin bot�n SALIR CONSULTAR. -->
<% } else { // no es "E" ni "Relacion_E"%>
<% if (permisoMantenimiento) {%>
    <!-- Bot�n Alta Desde Consulta. -->
...
<% }%>
	...
	<!-- Fin bot�n NUEVA CONSULTA. -->
    <!-- Bot�n ENVIAR REGISTRO A TRAV�S DEL CIR. -->
    ...
    <!-- Fin bot�n Bot�n ENVIAR REGISTRO A TRAV�S DEL CIR. -->
    <% }%>
...
<DIV id="capaBotonesAltaDesdeTramite" name="capaBotonesAltaDesdeTramite" style="display:none" class="botoneraPrincipal">
    <!-- Bot�n REGISTRAR ALTA DESDE TRAMITAR -->
        <input type="button" title='<%=descriptor.getDescripcion("toolTip_bAlta")%>' alt='<%=descriptor.getDescripcion("toolTip_bAlta")%>'
...
<DIV id="capaBotones4" name="capaBotones4" style="display:none" class="botoneraPrincipal">
    ...
    <!-- Bot�n CANCELAR CAMBIOS. -->
        <input type="button" title='<%=descriptor.getDescripcion("toolTip_bVolver")%>' alt='<%=descriptor.getDescripcion("toolTip_bVolver")%>'
               class="botonGeneral" value='<%=descriptor.getDescripcion("gbCancelar")%>'
               name="cmdCancelarModificar" onClick="pulsarSalirConsultar();return false;"/>
    <!-- Fin bot�n CANCELAR CAMBIOS. -->
    
    <!-- En #270948: Se a�ade el Bot�n Digitalizar a la capaBotones3-->
    <!-- En #326290: Este bot�n se elimina de la capaBotones3 y se a�ade a la capaBotones4-->
    <% if (mostrarDigitalizar) { %>
            <input type= "button" class="botonGeneral" value="Digitalizar" alt="Digitalizar documentos" 
...
// JAVASCRIPT DE LA PESTA�A DOCUMENTOS
...
tabAnt.addColumna('100','center','�rgano');
